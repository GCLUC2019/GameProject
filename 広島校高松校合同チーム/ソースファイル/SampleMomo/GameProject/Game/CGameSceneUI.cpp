...
CGameSceneUI::CGameSceneUI() :CObject(0, DP_UI)
{
	...
	//m_weapon_bar_p = new CBar(GET_RESOURCE("HP_Bar", CImage*), CCharacterPlayer::GetInstance()->GetHitPointPointer(), CCharacterPlayer::GetInstance()->GetHitPointMax(), m_ui_pos + CVector2D(178, 137), CVector2D(330, 25));
}
