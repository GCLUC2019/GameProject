...
void CPlayerTank::Init(){
	mGravityV = 0;
	AttackSide = 1;
	mTexImage.Load("data/Player-2.tga");
	mTexImage2.Load("data/P-ya.tga");
	mPlayerface.Load("data/playerface1.tga");	//HPバープレイヤー画像		追加　宮原
	mPlayerfaceD.Load("data/playerfaceD.tga");	//HPバープレイヤーダメージ画像
